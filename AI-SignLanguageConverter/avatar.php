...
$myfile = fopen("speech_recognition/out2.txt", "r") or die("Unable to open file!");
$ff="";
while(!feof($myfile)) {
  $ff=$ff.fgets($myfile);
}
...
<label for="inputText">Text: <?php echo $ff;?>  </label><br>


        <button onclick="yahoo();" id="a">go</button>
...
<div id="menu2">
<br>
<label for="inputText">Type text to convert to hindi:</rmbel><br>
